...
namespace TextClassifier_ConsoleApp
{
    public partial class TextClassifier
    {
        public const string RetrainFilePath =  @"C:\repos\MLWithMLNet-Course\TextClassifierConsoleApp\Data\FakeNewsNet_TrainingSet.csv";
